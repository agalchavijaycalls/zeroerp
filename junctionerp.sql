...
--
-- Table structure for table `expenser`
--

CREATE TABLE IF NOT EXISTS `expenser` (
  `project_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `task_id` int(11) NOT NULL,
  `date` varchar(20) NOT NULL,
  `expense_key` varchar(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `organization` (
  ...
  `updated_by` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT 'name of update person',
  `updated_on` varchar(30) NOT NULL COMMENT 'update of time'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table organizations for organization`s employee';
...
CREATE TABLE IF NOT EXISTS `project` (
  ...
  `estimate_cost` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `task` (
  ...
  `estimate_effort` varchar(100) NOT NULL,
  `actual_cost` varchar(50) NOT NULL,
  `actual_effort` varchar(100) NOT NULL,
...
--
-- Indexes for table `newregistration`
--
ALTER TABLE `newregistration`
...
ALTER TABLE `task`
  ...
  ADD KEY `foreign` (`project_id`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `newregistration`
--
ALTER TABLE `newregistration`
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'user id is auto increment  and primary key for users';
--
