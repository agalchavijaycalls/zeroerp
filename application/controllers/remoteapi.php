...
//   			print_r(json_encode($result));
 ...
 function saveReferenceSoughtData(){
 	...
 	{ 		
 		...
 		$query= "select * from seek_reference,loanapplication where seek_reference.emailId='$referralEmailId' and 	referalEmailId.emailId ='$emailId' and seek_reference.date_time='$dateTime' and loanapplication.emailId=seek_reference.emailId and seek_reference.date_time=loanapplication.date_time";
 		$sql=mysqli_query($CONNECTION,$query);
