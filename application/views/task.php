...
<!-- manage organization body starts -->
	<div class="page-title">
		<div class="title-env">
			<h1 class="title">Manage Project Detail</h1>
			<p class="description">Manage Your Project Detail</p>
		</div>
		<div class="breadcrumb-env">
			<ol class="breadcrumb bc-1">
				...
				<li class="active">
					<strong>Manage Project Detail</strong>
				</li>
			</ol>
		</div>
	</div>
					...
					<script type="text/javascript">
					  ...
					  <div class="table-responsive"  data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">	
						<table id="example-1"  cellspacing="0" class="table table-small-font table-bordered table-striped">
							...
							<tbody>
							<?php $i=1; foreach($ApplicationTaskList as $list){ ?>
								<tr>
									<td><?=$i;?></td>
									<td><?php foreach ($ApplicationTaskProjectList as $ProjectList){ if(isset($ProjectList->project_id)&& $list->project_id==$ProjectList->project_id) { echo $ProjectList->project_description; break; } else { echo '';} }?></td>
